<template>
  <div id="Fashion">
    <Appbar title="包箱服饰" type="1"/>
    <div class="details">
      <div class="part1">
        <ul>
          <li>
            <img src="../../../assets/index/fashion/bag.png" alt="">
            <h2>箱包</h2>
          </li>
          <li>
            <img src="../../../assets/index/fashion/tie.png" alt="">
            <h2>服装</h2>
          </li>
          <li>
            <img src="../../../assets/index/fashion/bootie.png" alt="">
            <h2>鞋靴</h2>
          </li>
          <li>
            <img src="../../../assets/index/fashion/ring.png" alt="">
            <h2>饰品</h2>
          </li>
        </ul>
      </div>
