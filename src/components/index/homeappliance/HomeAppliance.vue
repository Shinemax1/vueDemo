<template>
  <div id="HomeAppliance">
    <Appbar title="家具家电" type="1"/>
    <div class="details">
      <div class="part1">
        <ul>
          <li>
            <img src="../../../assets/index/homeappliance/dianqi.png" alt="">
            <h2>家用电器</h2>
          </li>
          <li>
            <img src="../../../assets/index/homeappliance/jiaju.png" alt="">
            <h2>家具</h2>
          </li>
          <li>
            <img src="../../../assets/index/homeappliance/zhuanghuang.png" alt="">
            <h2>装修装潢</h2>
          </li>
          <li>
            <img src="../../../assets/index/homeappliance/yuwei.png" alt="">
            <h2>卫浴用具</h2>
          </li>
        </ul>
      </div>
