<template>
  <div id="Fitness">
    <Appbar title="运动健身" type="1"/>
    <div class="details">
      <div class="part1">
        <ul>
          <li>
            <img src="../../../assets/index/fitness/weight.png" alt="">
            <h2>健身房</h2>
          </li>
          <li>
            <img src="../../../assets/index/fitness/yujia.png" alt="">
            <h2>瑜伽馆</h2>
          </li>
          <li>
            <img src="../../../assets/index/fitness/youyong.png" alt="">
            <h2>游泳馆</h2>
          </li>
          <li>
            <img src="../../../assets/index/fitness/huabing.png" alt="">
            <h2>滑冰场</h2>
          </li>
          <li>
            <img src="../../../assets/index/fitness/taiqiu.png" alt="">
            <h2>台球吧</h2>
          </li>
          <li>
            <img src="../../../assets/index/fitness/basketball.png" alt="">
            <h2>篮球场</h2>
          </li>
          <li>
            <img src="../../../assets/index/fitness/yumaoqiu.png" alt="">
            <h2>羽毛球馆</h2>
          </li>
          <li>
            <img src="../../../assets/index/fitness/baolingqiu.png" alt="">
            <h2>保龄球馆</h2>
          </li>
        </ul>
      </div>
