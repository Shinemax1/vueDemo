<template>
  <div id="Entertainment">
    <Appbar title="休闲娱乐" type="1"/>
    <div class="details">
      <div class="part1">
        <ul>
          <li>
            <img src="../../../assets/index/entertainment/mishi.png" alt="">
            <h2>密室逃脱</h2>
          </li>
          <li>
            <img src="../../../assets/index/entertainment/KTV.png" alt="">
            <h2>KTV唱歌</h2>
          </li>
          <li>
            <img src="../../../assets/index/entertainment/movie.png" alt="">
            <h2>电影院</h2>
          </li>
          <li>
            <img src="../../../assets/index/entertainment/coffee.png" alt="">
            <h2>茶馆咖啡</h2>
          </li>
          <li>
            <img src="../../../assets/index/entertainment/game.png" alt="">
            <h2>电玩桌游</h2>
          </li>
          <li>
            <img src="../../../assets/index/entertainment/netbar.png" alt="">
            <h2>网吧网咖</h2>
          </li>
          <li>
            <img src="../../../assets/index/entertainment/qipai.png" alt="">
            <h2>棋牌室</h2>
          </li>
          <li>
            <img src="../../../assets/index/entertainment/jiuba.png" alt="">
            <h2>酒吧轻吧</h2>
          </li>
        </ul>
      </div>
