<template>
  <div id="KeepHealth">
    <Appbar title="养生保健" type="1"/>
    <div class="details">
      <div class="part1">
        <ul>
          <li>
            <img src="../../../assets/index/keephealth/zuliao.png" alt="">
            <h2>足疗按摩</h2>
          </li>
          <li>
            <img src="../../../assets/index/keephealth/xiyu.png" alt="">
            <h2>洗浴汗蒸</h2>
          </li>
          <li>
            <img src="../../../assets/index/keephealth/meirong.png" alt="">
            <h2>美容美发</h2>
          </li>
          <li>
            <img src="../../../assets/index/keephealth/sheying.png" alt="">
            <h2>摄影写真</h2>
          </li>
        </ul>
      </div>
